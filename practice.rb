...
#Start with the positive transfers
ben_amount = 0 
brian_amount = 0
evan_amount = 0
anthony_amount = 0
...
if blockchain[index]["to_user"] == "ben"
  ben_amount = ben_amount + blockchain[index]["amount"]
end
index = index + 1
end
...
if blockchain[index]["to_user"] == "brian"
  brian_amount = brian_amount + blockchain[index]["amount"]
end
index = index + 1
end
...
if blockchain[index]["to_user"] == "evan"
  evan_amount = evan_amount + blockchain[index]["amount"]
end
index = index + 1
end
...
if blockchain[index]["to_user"] == "anthony"
  anthony_amount = anthony_amount + blockchain[index]["amount"]
end
index = index + 1
end

#Now We will do the negative transfers
